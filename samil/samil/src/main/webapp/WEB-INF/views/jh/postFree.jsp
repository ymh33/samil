...
<form action="listSearch5" style="text-align: center;">
    <!-- 검색 기준 선택 드롭다운 -->
    <h2 style="margin-top: 50px; margin-bottom: 1px; padding-right: 800px;">자유게시판</h2>
    ...
    <table border="1">
        ...
        <c:forEach var="posts" items="${listPosts2}" varStatus="status">
         <tr><td>${status.index + 1}</td>
         	 <td style="text-align: left;"><a href="/jh/detailPostsfree/${posts.postId}">${posts.postsTitle}</a></td>
         	 <td>${posts.empno}</td>
