...
<main id="printableArea">
    <form id="expForm" method="post">
        ...
        <table>
        	...
        	<tr>
        		<th>
				  ${approval.costDetailsCode == 100 ? '비품' :
				    approval.costDetailsCode == 110 ? '유류비' :
				    approval.costDetailsCode == 120 ? '공과금' :
				    approval.costDetailsCode == 130 ? '특수비용' : '기타'}
				</th>
        		<th>${approval.costDetailsCnt }</th>
        		<th>${approval.costQuantity }</th>
        		<th>${approval.costUnitPrice }</th>
        		<th>${approval.costAmount }</th>
        	</tr>
        	<tr>
        		<th></th>
        		<th></th>
        		<th></th>
        		<th></th>
        		<th>합계 : ${approval.costAmount}</th></tr>	
        </table>
